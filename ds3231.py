...
#               sec min hour week day month year
    ...
    def set_time_from_localtime(self):
        import time
        _t = time.localtime()
        week_day = self.w[(_t[6] + 1) % 7] # [Mon - Sun] => [Sun - Sat]
        new_time = "{:02d}:{:02d}:{:02d},{},{:04d}-{:02d}-{:02d}".format(_t[3],_t[4],_t[5],week_day,_t[0],_t[1],_t[2])
